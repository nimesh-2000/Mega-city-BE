...
import org.denuwan.mega.megacity.config.DBConfig;
...
public class BookingDAO  {
    ...
    public boolean createBooking(Booking booking) {
        String sql = "INSERT INTO bookings (user_id, car_id, start_date, end_date, total_amount, status , driverId) VALUES (?, ?, ?, ?, ?, ?, ?)";
